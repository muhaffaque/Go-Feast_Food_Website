...
//For Menu
    <div className='max-w-[1520px] mx-auto flex justify-between items-center p-4'>
      <div className='flex items-center'>
        ...
        <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>Go
          <span className='font-bold'>Feast</span>
        </h1>
      ...
      <div className={sideNav?'bg-white fixed top-0 left-0 w-[300px] h-screen z-10 duration-200'
                      :'bg-white fixed top-0 left-[-100%] w-[300px] h-screen z-10 duration-200'
                    }>
        ...
        <h2 className='text-2xl p-4'>Go<span className='text-orange-700 font-bold'>Feast</span></h2>
        <nav>
